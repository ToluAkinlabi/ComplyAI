...
* When an old valuable .json report in the compliance dashboard don't have a priority field but the .json file is still relevant and you want to view them via the dashboard filters, you can run the retroactive patch script `scripts/patch_priority_in_reports.py`